        ...
        <main className="md:ml-[16.25rem] xl:ml-[21.125rem] pt-[62px] md:pt-[6.5625rem] w-full">
          ...
          <div className="pt-10 pb-[10.4375rem] py-[3.0625rem] xl:py-[3.8125rem] px-[26px] md:px-8 xl:px-[3.4375rem]">
            <div className="bg-black-200 pt-[30px] md:pt-9 pl-5 md:pl-10 xl:pl-[3.4375rem] pr-3 md:pr-8 pb-[5.3125rem] xl:pb-[6.375rem] rounded-[25px]">
              ...
              <div>
                {/* TEXT */}
                <div className="mb-6 md:mb-9 xl:mb-[18px]">
                  <h3 className="bg-gradient-text text-f_22_l_28 mb-3 md:mb-[7px] xl:mb-[5px]">
                    System tutorial videos
                  </h3>

                  <p className="text-f_18_l_28">
                    You can find easily and clearly explained videos on how to
                    use the system here:
                  </p>
                </div>
                ...
                <ul className="space-y-[7px]">
                  ...
                  <li className="flex items-center">
                    <span className="block w-[7px] h-[7px] rounded-full bg-blue mr-1 md:mr-3.5"></span>
                    <a href="#abc" className=" text-blue text-f_18_l_28">https://www.google.com/search?</a>
                  </li>
